...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <header className="w-full bg-white shadow-sm py-4 px-6 md:px-8 flex items-center justify-between">
        <Link 
          to="/" 
        ...
        <Link to="/" className="text-lg font-bold text-green-700 tracking-wide">
          GREAT CONNECTION
        </Link>
      </header>
