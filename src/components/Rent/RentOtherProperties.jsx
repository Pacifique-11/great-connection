  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        ...
        // Safely extract arrays whether they are root arrays or nested under .data / .properties
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 mt-28 mb-16">
      <header className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">Here you can see different properties and assets</p>
      </header>
            ...
            >
              ...
              <div className="mt-6">
                <Link to={`/${property.type}/${property._id || property.id}`}>
                  <button className="w-full bg-green-500 text-white px-4 py-2.5 rounded-lg font-medium hover:bg-green-600 transition-colors cursor-pointer">
                    View Details
                  </button>
                </Link>
              </div>
